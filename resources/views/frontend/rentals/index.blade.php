        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <p class="text-black-600 mb-4 font-bold text-xl">Total Rentals: {{ $currentRentals->count() + $pastRentals->count() }}</p>
                    ...
                    <table class="w-full table-auto mb-8">
                        ...
                        <tbody>
                            @if(isset($currentRentals) && $currentRentals->isNotEmpty())
                                @foreach ($currentRentals as $rental)
                                    <tr>
                                        ...
                                        <td class="border px-4 py-2">
                                            <a href="{{ route('rental.edit', $rental->id) }}" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Edit</a>
                    ...
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                            @if(isset($pastRentals) && $pastRentals->isNotEmpty())
